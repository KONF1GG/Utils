...
PROMPT_TEMPLATES = {
    ...
    2. Если вопрос о тарифах:
       - Если в контексте представлен именно словарь с тарифами, ответь на вопрос как обычно.
    ...
    4. Используй только эти теги HTML (<b>, <i>, <a>, <code>, <pre>) НЕЛЬЗЯ ИСПОЛЬЗОВАТЬ: <ul>, <br>, <table>, <small> и остальные!
    5. Укажи ссылку на источник из WIKI, если используешь информацию из контекста и ссылка там есть.
    """
}
